...
CARGO_MANIFEST_PATH = "${S}/status_bar/Cargo.toml"
...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/status_bar
         cp -r ${S}/status_bar/src/assets ${D}/usr/share/mechanix-shell/status_bar/

         install -d ${D}${sysconfdir}/mechanix-shell/status_bar
         install -m 0755 ${S}/status_bar/settings.yml.example ${D}${sysconfdir}/mechanix-shell/status_bar
}
