...
# how to get background could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/background/1.0.0"
...
S = "${WORKDIR}/git"
# CARGO_SRC_DIR = "background"
PV:append = ".AUTOINC+651c42b218"
CARGO_MANIFEST_PATH = "${S}/background/Cargo.toml"
...
SUMMARY = "Background services used to change background"
