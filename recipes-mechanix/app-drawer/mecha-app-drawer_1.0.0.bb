...
CARGO_MANIFEST_PATH = "${S}/app_drawer/Cargo.toml"
...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/app_drawer
         cp -r ${S}/app_drawer/src/assets ${D}/usr/share/mechanix-shell/app_drawer/

         install -d ${D}${sysconfdir}/mechanix-shell/app_drawer
         install -m 0755 ${S}/app_drawer/settings.yml.example ${D}${sysconfdir}/mechanix-shell/app_drawer
}
