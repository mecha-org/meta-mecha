...
CARGO_MANIFEST_PATH = "${S}/settings_drawer/Cargo.toml"
...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/settings_drawer
         cp -r ${S}/settings_drawer/src/assets ${D}/usr/share/mechanix-shell/settings_drawer/

         install -d ${D}${sysconfdir}/mechanix-shell/settings_drawer
         install -m 0755 ${S}/settings_drawer/settings.yml.example ${D}${sysconfdir}/mechanix-shell/settings_drawer
}
