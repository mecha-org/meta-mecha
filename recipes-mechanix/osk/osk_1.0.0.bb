...
# how to get osk could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/osk/1.0.0"
...
CARGO_MANIFEST_PATH = "${S}/osk/Cargo.toml"
...
RDEPENDS:${PN} += "squeekboard"

# do_install:append() {
#          install -d ${D}/usr/share/osk
#          cp -r ${S}/osk/src/assets ${D}/usr/share/osk/

#          install -d ${D}${sysconfdir}/mechanix-shell
#          install -m 0755 ${S}/osk/settings.yml.example ${D}${sysconfdir}/mechanix-shell
# }
