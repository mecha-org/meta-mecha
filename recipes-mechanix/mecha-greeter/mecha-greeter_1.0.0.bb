...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/greeter
         cp -r ${S}/greeter/src/assets ${D}/usr/share/mechanix-shell/greeter/

         install -d ${D}${sysconfdir}/mechanix-shell/greeter
         install -m 0755 ${S}/greeter/settings.yml.example ${D}${sysconfdir}/mechanix-shell/greeter
}
