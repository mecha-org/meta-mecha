...
# how to get rotation could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/rotation/1.0.0"
...
S = "${WORKDIR}/git"
# CARGO_SRC_DIR = "rotation"
PV:append = ".AUTOINC+651c42b218"
CARGO_MANIFEST_PATH = "${S}/rotation/Cargo.toml"
...
SUMMARY = "Rotation service used to rotate screen"
