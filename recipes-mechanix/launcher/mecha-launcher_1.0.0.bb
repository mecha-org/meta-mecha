...
# how to get mecha_launcher could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/mecha_launcher/1.0.0"
...
S = "${WORKDIR}/git"
# CARGO_SRC_DIR = "launcher"
PV:append = ".AUTOINC+651c42b218"
CARGO_MANIFEST_PATH = "${S}/launcher/Cargo.toml"
...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/launcher
         cp -r ${S}/launcher/src/assets ${D}/usr/share/mechanix-shell/launcher/

         install -d ${D}${sysconfdir}/mechanix-shell/launcher
         install -m 0755 ${S}/launcher/settings.yml.example ${D}${sysconfdir}/mechanix-shell/launcher
}
...
include mecha_launcher-${PV}.inc
include mecha_launcher.inc
