...
CARGO_MANIFEST_PATH = "${S}/action_bar/Cargo.toml"
...
do_install:append() {
        install -d ${D}/usr/share/mechanix-shell/action_bar
        cp -r ${S}/action_bar/src/assets ${D}/usr/share/mechanix-shell/action_bar/

        install -d ${D}${sysconfdir}/mechanix-shell/action_bar
        install -m 0755 ${S}/action_bar/settings.yml.example ${D}${sysconfdir}/mechanix-shell/action_bar
}
