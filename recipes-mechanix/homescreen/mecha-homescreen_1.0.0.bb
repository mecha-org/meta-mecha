...
# how to get mecha_homescreen could be as easy as but default to a git checkout:
# SRC_URI += "crate://crates.io/mecha_homescreen/1.0.0"
...
S = "${WORKDIR}/git"
# CARGO_SRC_DIR = "homescreen"
PV:append = ".AUTOINC+651c42b218"
CARGO_MANIFEST_PATH = "${S}/homescreen/Cargo.toml"
...
SUMMARY = "Homescreen for mecha launcher"
...
do_install:append() {
         install -d ${D}/usr/share/homescreen
         cp -r ${S}/homescreen/src/assets ${D}/usr/share/homescreen/

         install -d ${D}${sysconfdir}/mechanix-shell
         install -m 0755 ${S}/homescreen/settings.yml.example ${D}${sysconfdir}/mechanix-shell
}
...
include mecha_homescreen-${PV}.inc
include mecha_homescreen.inc
