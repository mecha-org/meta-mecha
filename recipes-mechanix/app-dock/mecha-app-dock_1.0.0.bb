...
CARGO_MANIFEST_PATH = "${S}/app_dock/Cargo.toml"
...
do_install:append() {
         install -d ${D}/usr/share/mechanix-shell/app_dock
         cp -r ${S}/app_dock/src/assets ${D}/usr/share/mechanix-shell/app_dock/

         install -d ${D}${sysconfdir}/mechanix-shell/app_dock
         install -m 0755 ${S}/app_dock/settings.yml.example ${D}${sysconfdir}/mechanix-shell/app_dock
}
